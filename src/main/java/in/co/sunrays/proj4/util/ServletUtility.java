...
public class ServletUtility {
	 ...
	 * @param request
	 */
	public static void setList(List<String> list, HttpServletRequest request) {
	...
	public static int getPageNo(HttpServletRequest request) {
		return DataUtility.getInt(DataUtility.getStringData(request.getAttribute("pageNo")));
	...
	public static int getPageSize(HttpServletRequest request) {
		return DataUtility.getInt(DataUtility.getStringData(request.getAttribute("pageSize")));
	}
