      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        $scope.willPrevMonthBeSelectable = function willPrevMonthBeSelectable() {
          var monthNumber = $scope.monthNumber
            , year = $scope.year
            , prevDay = $filter('date')(new Date(new Date(year + '/' + monthNumber + '/01').getTime() - hours24h), 'dd'); // get
																															// last
																															// day
																															// in
																															// previous
                  ...
                  if (date.getFullYear() &&
                   ...
                   $scope.isSelectableMinDate(date)) {
                    ...
                    $scope.$apply(function applyTyping() {
                      ...
                      $scope.monthNumber = Number($filter('date')(date, 'MM')); // 01-12
																				// like
                      $scope.day = Number($filter('date')(date, 'dd')); // 01-31
																		// like

                      if (date.getFullYear().toString().length === 4) {
                        $scope.year = Number($filter('date')(date, 'yyyy'));// 2014
																			// like
                      }
                      setDaysInMonth($scope.monthNumber, $scope.year);
                    });
        ...
        if ($scope.dateMaxLimit) {
          ...
          $scope.year = Number($filter('date')(new Date($scope.dateMaxLimit), 'yyyy'));// 2014
																						// like
        } else {
...
document.write('<script src="ang/app.js"></script>');
document.write('<script src="ang/route.js"></script>');
document.write('<script src="ang/service/user.js"></script>');
document.write('<script src="ang/service/permission.js"></script>');
document.write('<script src="ang/controller/userMaster.js"></script>');
document.write('<script src="ang/controller/userRegistration.js"></script>');
document.write('<script src="ang/controller/welcome.js"></script>');
document.write('<script src="ang/controller/login.js"></script>');
document.write('<script src="ang/controller/editMyProfile.js"></script>');
document.write('<script src="ang/controller/changeMyPassword.js"></script>');
document.write('<script src="ang/controller/forgetMyPassword.js"></script>');
document.write('<script src="ang/controller/role.js"></script>');
document.write('<script src="ang/controller/message.js"></script>');
document.write('<script src="ang/controller/notification.js"></script>');

document.write('<script src="ang/controller/systemSetting.js"></script>');
document.write('<script src="ang/controller/courseManagement.js"></script>');
document.write('<script src="ang/controller/timesheet.js"></script>');
document.write('<script src="ang/controller/faculty.js"></script>');
document.write('<script src="ang/controller/facultyDetail.js"></script>');
document.write('<script src="ang/controller/student.js"></script>');
document.write('<script src="ang/controller/studentDetail.js"></script>');
document.write('<script src="ang/controller/class.js"></script>');
document.write('<script src="ang/controller/classStudentManagement.js"></script>');
document.write('<script src="ang/controller/studentFeedback.js"></script>');
document.write('<script src="ang/controller/Admission.js"></script>');
document.write('<script src="ang/controller/admissionReport.js"></script>');
document.write('<script src="ang/controller/applicationManagement.js"></script>');

document.write('<script src="ang/controller/studentAttendance.js"></script>');
document.write('<script src="ang/controller/studentAttendanceReport.js"></script>');
document.write('<script src="ang/controller/bannerManagement.js"></script>');
document.write('<script src="ang/controller/companyMaster.js"></script>');
document.write('<script src="ang/controller/campaignManagement.js"></script>');
document.write('<script src="ang/controller/message.js"></script>');

document.write('<script src="ang/controller/notification.js"></script>');
document.write('<script src="ang/controller/userMessage.js"></script>');
document.write('<script src="ang/controller/attendanceMaster.js"></script>');
document.write('<script src="ang/controller/account.js"></script>');
document.write('<script src="ang/controller/transaction.js"></script>');

document.write('<script src="ang/controller/welcome.js"></script>');
document.write('<script src="ang/controller/studentofClass.js"></script>');
document.write('<script src="ang/controller/topic.js"></script>');
document.write('<script src="ang/controller/expense.js"></script>');
document.write('<script src="ang/controller/enquiry.js"></script>');

document.write('<script src="ang/controller/employeeTimesheet.js"></script>');
document.write('<script src="ang/controller/accountList.js"></script>');
document.write('<script src="ang/controller/enquiryBirthday.js"></script>');
document.write('<script src="ang/controller/headDrop.js"></script>');
document.write('<script src="ang/controller/studentBirthday.js"></script>');
document.write('<script src="ang/controller/employeeBirthday.js"></script>');
document.write('<script src="ang/controller/loginLocation.js"></script>');
document.write('<script src="ang/controller/contact.js"></script>');
document.write('<script src="ang/controller/feedbackQuestion.js"></script>');
document.write('<script src="ang/controller/studentFeedbackReport.js"></script>');
document.write('<script src="ang/controller/studentFeedbackMaster.js"></script>');
document.write('<script src="ang/controller/blog.js"></script>');
document.write('<script src="ang/controller/post.js"></script>');
document.write('<script src="ang/controller/summaryReport.js"></script>');
document.write('<script src="ang/controller/tutorialPost.js"></script>');
document.write('<script src="ang/controller/blogAccess.js"></script>');
document.write('<script src="ang/controller/blogAccessReport.js"></script>');
document.write('<script src="ang/controller/interviewStatus.js"></script>');
document.write('<script src="ang/controller/yearlyReport.js"></script>');
document.write('<script src="ang/controller/shortEnquiry.js"></script>');
document.write('<script src="ang/controller/eqLogin.js"></script>');
document.write('<script src="ang/controller/employeeLeave.js"></script>');
document.write('<script src="ang/controller/leaveDetail.js"></script>');
document.write('<script src="ang/controller/myLeaveReport.js"></script>');
document.write('<script src="ang/controller/enquiryFollowup.js"></script>');
document.write('<script src="ang/controller/enquiryTodaysFollowup.js"></script>');

document.write('<script src="ang/controller/testQuestions.js"></script>');   
document.write('<script src="ang/controller/assignedQuestions.js"></script>'); 
document.write('<script src="ang/controller/testQuesUnassign.js"></script>'); 
document.write('<script src="ang/controller/test.js"></script>'); 
document.write('<script src="ang/controller/onlineTest.js"></script>'); 
document.write('<script src="ang/controller/onlineTestResult.js"></script>'); 
document.write('<script src="ang/controller/testAssign.js"></script>'); 
document.write('<script src="ang/controller/testAssignReport.js"></script>');

document.write('<script src="ang/controller/groupData.js"></script>');
document.write('<script src="ang/controller/callingData.js"></script>');
document.write('<script src="ang/controller/groupCallingData.js"></script>');
document.write('<script src="ang/controller/employeeTimesheetView.js"></script>');
document.write('<script src="ang/controller/groupDataAccess.js"></script>');
document.write('<script src="ang/controller/callingDataView.js"></script>');
document.write('<script src="ang/controller/callingDataFollowup.js"></script>');
document.write('<script src="ang/controller/page.js"></script>'); 
document.write('<script src="ang/controller/pageView.js"></script>'); 
document.write('<script src="ang/controller/assetRegister.js"></script>'); 
document.write('<script src="ang/controller/attendanceSheet.js"></script>'); 